...
namespace TheToolsmiths.Ddl.Writer.Parser.Ast.Writers
{
    ...
    {
        public static void WriteTypeIdentifier(IStructuredContentWriter writer, ITypeIdentifier typeIdentifier)
        {
        ...
        private static void WriteTypeIdentifierProperties(IStructuredContentWriter writer, ITypeIdentifier typeIdentifier)
        {
        ...
        private static void WriteArrayTypeIdentifierProperties(IStructuredContentWriter writer, ArrayTypeIdentifier identifier)
        {
        ...
        private static void WriteArrayDimensions(IStructuredContentWriter writer, IEnumerable<ArraySize> sizes)
        {
        ...
        public static void WriteTypeName(IStructuredContentWriter writer, TypeName typeName)
        {
            writer.WriteStartObject();

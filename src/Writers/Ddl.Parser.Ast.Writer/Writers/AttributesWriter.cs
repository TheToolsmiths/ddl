...
namespace TheToolsmiths.Ddl.Parser.Ast.Writer.Writers
{
    public static class AttributesWriter
    {
        ...
        private static void WriteAttributeUse(IStructuredWriter writer, IAstAttributeUse attributeUse)
        {
        ...
        private static void WriteKeyedLiteralAttributeUse(IStructuredWriter writer, KeyedLiteralAstAttributeUse keyedLiteral)
        {
        ...
        private static void WriteKeyedTypedAttributeUse(IStructuredWriter writer, KeyedTypedAstAttributeUse keyedTyped)
        {
        ...
        private static void WriteKeyedStructInitializationAttributeUse(IStructuredWriter writer, KeyedStructInitializationAstAttributeUse typed)
        {
        ...
        private static void WriteTypedAttributeUse(IStructuredWriter writer, AstTypedStructInitializationUse typed)
        {
        ...
        private static void WriteConditionalAttributeUse(IStructuredWriter writer, ConditionalAstAttributeUse conditional)
        {
